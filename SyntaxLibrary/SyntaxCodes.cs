...
namespace SyntaxMPProtection
{
    ...
    //    public Main()
    //    {
    //        DMPModInterface.RegisterModHandler("SyntaxMPProtection", HandleMessage);
    //    }
    ...
    //        DMPModInterface.SendDMPModMessageToClient(client, "SyntaxMPProtection", messageData, highPriority);
    //        if(SyntaxCode.SyntaxPlayerVessel.CheckOwner(client.playerName))
    //        {
    ...
    //    {
    //        if(messageData.type == DarkMultiPlayerCommon.ClientMessageType.CHAT_MESSAGE)
    //        {
    //            if(client.activeVessel != null && client.activeVessel != "")
    //            {
    //                if (SyntaxCode.SyntaxPlayerVessel.CheckOwner(client.playerName))
    //                {
    ...
    //            }
    //        }
    //        base.OnMessageReceived(client, messageData);
    //    }
    //    public override void OnServerStart()
    //    {
    //        PlayerSecurity ps = new PlayerSecurity();
    //    }
    //    public override Enum ClientMessageType
    //    {
