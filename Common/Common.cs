...
namespace DarkMultiPlayerCommon
{
    public class Common
    {
        ...
        public const int PROTOCOL_VERSION = 37;
        ...
        public static List<string> GetStockParts()
        {
            ...
            stockPartList.Add("mk3Cockpit_Shuttle");
            stockPartList.Add("ksp_r_largeBatteryPack");
            stockPartList.Add("solidBooster_sm");
            stockPartList.Add("fuelTank_long");
            stockPartList.Add("mk2_1m_Bicoupler");
            stockPartList.Add("mk2_1m_AdapterLong");
            stockPartList.Add("mk3FuselageLFO_100");
            stockPartList.Add("mk3FuselageLFO_25");
            stockPartList.Add("mk3FuselageLFO_50");
            stockPartList.Add("mk3FuselageLF_100");
            stockPartList.Add("mk3FuselageLF_25");
            stockPartList.Add("mk3FuselageLF_50");
            ...
            stockPartList.Add("Large_Crewed_Lab");
            stockPartList.Add("science_module");
            stockPartList.Add("radialDrogue");
            stockPartList.Add("ServiceBay_125");
            stockPartList.Add("ServiceBay_250");
