    ...
    internal class InstallChecker : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            if (!IsCorrectlyInstalled())
            {
                ...
                PopupDialog.SpawnPopupDialog(new Vector2(0,0), new Vector2(0, 0), "Incorrect Install", "Incorrect Install Detected", String.Format("DarkMultiPlayer is not correctly installed.\n\nCurrent location: {0}\n\nCorrect location: {1}\n", currentPath, correctPath), "OK", false, HighLogic.UISkin);
            }
        }
    }
}
